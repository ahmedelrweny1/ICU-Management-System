...
-- Execute this script AFTER DDL_Script.sql
...
-- ============================================
-- STEP 2: Insert Staff (No dependencies)
...
(8, 'doc004', '$2a$11$K7L1OJ45/4Y2nIvhRVxCe.swSmGIdZlDx29Lano4hcB8f19AhUJ8S', 'Dr. Jennifer Lee', 'Doctor', 'Neurologist', '+1-555-0109', 'jennifer.lee@shefaa.com', 0, '2024-01-15 08:00:00'),
(9, 'nurse004', '$2a$11$K7L1OJ45/4Y2nIvhRVxCe.swSmGIdZlDx29Lano4hcB8f19AhUJ8S', 'Nurse Thomas White', 'Nurse', 'Trauma Care', '+1-555-0110', 'thomas.white@shefaa.com', 0, '2024-01-15 08:00:00');

SET IDENTITY_INSERT Staff OFF;
GO

-- ============================================
-- STEP 3: Insert Rooms (No dependencies)
-- ============================================
...
-- ============================================
-- STEP 4: Insert Patients (Depends on Rooms)
-- ============================================
...
-- ============================================
-- STEP 5: Insert AttendanceLogs (Depends on Staff)
-- ============================================
...
(7, 8, '2024-01-30 08:00:00', NULL, 0),
(8, 9, '2024-01-30 16:00:00', NULL, 0),
...
-- ============================================
-- STEP 6: Insert Schedules (Depends on Staff)
-- ============================================
...
(7, '2024-02-01', 1, 8, 'Evening shift - Neurology rounds'),
(8, '2024-02-01', 2, 6, 'Night shift - On-call nurse'),
(9, '2024-02-01', 2, 9, 'Night shift - Trauma care'),
(10, '2024-02-02', 0, 2, 'Morning shift - Cardiology rounds');

SET IDENTITY_INSERT Schedules OFF;
GO

-- ============================================
-- STEP 7: Insert Vitals (Depends on Patients)
-- ============================================
...
-- ============================================
-- STEP 8: Insert Medications (Depends on Patients and Staff)
-- ============================================
...
-- ============================================
-- STEP 9: Insert ClinicalNotes (Depends on Patients and Staff)
-- ============================================
...
(10, 9, 8, '2024-01-30 08:00:00', 'Acute stroke patient. Thrombolytic therapy administered. Monitoring for improvement in neurological status.');

SET IDENTITY_INSERT ClinicalNotes OFF;
GO

-- ============================================
-- DML Script Completed Successfully
-- ============================================
PRINT 'Sample data inserted successfully!';
PRINT 'Total records:';
PRINT '  - Staff: 9 records';
PRINT '  - Rooms: 10 records';
PRINT '  - Patients: 10 records';
PRINT '  - AttendanceLogs: 10 records';
PRINT '  - Schedules: 10 records';
PRINT '  - Vitals: 10 records';
PRINT '  - Medications: 10 records';
PRINT '  - ClinicalNotes: 10 records';
GO
